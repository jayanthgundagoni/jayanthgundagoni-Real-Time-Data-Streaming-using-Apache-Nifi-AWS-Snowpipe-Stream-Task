...
-- Set the active role to AccountAdmin before granting the execute task privilige to Taskadmin
...
create or replace task task_scd_raw warehouse = COMPUTE_WH schedule = '1 minute'
